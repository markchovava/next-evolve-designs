...
export default function ProjectSection({ projectLatest }) {
            ...
            projectLatest.map(item => (
                ...
                <div className='group-hover:opacity-0 transition-all duration-300 w-[100%] flex items-center justify-center py-4 bg-slate-900/70 drop-shadow-lg text-xl font-semibold text-white shadow-lg'>
                    ...
                    <div className='w-[100%] h-[100%] opacity-0 group-hover:opacity-100 transition-all duration-300 
                        ...
                        <Link href={`/projects/project/${item.id}`} className='group transition ease-in-out duration-200  flex items-center justify-center gap-1 rounded-xl py-[1rem] px-[2rem] text-white border hover:bg-gradient-to-br  hover:from-slate-500 hover:to-slate-700'>
