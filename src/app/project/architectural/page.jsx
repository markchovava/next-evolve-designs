    ...
    <div>
      ...
      <section className='w-[100%] bg-slate-50'>
        <div className='mx-auto w-[90%]'>
            <ul className='py-2 flex items-center justify-start gap-2'>
              ...
              <li><BsChevronRight /></li>
              <li className='flex justify-start items-center'>
                <Link href='/project/architectural' className='font-semibold'>
                 Architecture</Link>
              </li>
            </ul>
        </div>
      ...
      <section className='w-[100%] h-auto'>
        <div className='w-[90%] h-[100%] mx-auto py-[5rem]'>
          <div className="flex items-center justify-center flex-col">
            <h1 className="leading-none pb-[1.5rem] text-center font-extrabold text-[4rem]">Our Architecture Projects</h1>
