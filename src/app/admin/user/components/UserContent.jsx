                ...
                data.map(item =>(
                  <div key={item.id} className="w-[100%] flex items-center justify-start py-3 border border-slate-200 ">
                      <div className="w-[30%] p-3 ">
                        {`${item.first_name && item.last_name ? item.first_name + ' ' + item.last_name  : 'Not yet Added.'}`}</div>
                      <div className="w-[20%] p-3 border-l border-slate-300">
                        {item.phone_number ? item.phone_number : 'Not yet Added.'}</div>
                      <div className="w-[30%] p-3 border-l border-slate-300">
                        {item.email ? item.email : 'Not yet added.'}</div>
